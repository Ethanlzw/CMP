function [bcMatrix, bcVector] = assembleNaturalBC_Piezo(model)
% Assemble piezoelectric natural BC contributions
...
for i = 1:size(nat.edges, 1)
    ...
    [edgeMatrix, edgeVector] = Edge2_Piezo(edgeNodesInfo, bc, model.problem, model.loads, state);
